        ...
        <div class="col-md-3">
           <div class="sidenav">
             <ul class="list-group">
               ...
               <li class="list-group-item active"><a href="<?php echo u('user/center/card');?>">点卡充值</a></li>
            </ul>
          </div>
        </div>
        <div class="col-md-9">	
          <div class="panel panel-default panel-col">
	        <div class="panel-heading">点卡充值</div>
             <div class="panel-body">
             <br>  
            <form class="form-horizontal js-ajax-form" action="<?php echo U('user/center/card_post');?>" method="post">
               <div class="form-group">   
                 <div class="col-md-3 control-label">
                   <label for="money_card_secret">点卡卡号</label>
                 </div>
                 <div class="controls col-md-7">
                    <input type="text" name="card_name" required="required" class="form-control">
                    <p class="help-block">请输入学习卡的卡号</p>
                 </div>
              </div>
             <div class="form-group">
                <div class="col-md-3 control-label">
