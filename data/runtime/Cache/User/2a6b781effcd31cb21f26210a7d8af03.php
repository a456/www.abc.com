        ...
        <div class="col-md-3">
           <div class="sidenav">
             <ul class="list-group">
               ...
               <li class="list-group-item active"><a href="<?php echo u('user/center/pic');?>">头像设置</a></li>
              ...
              <div class="form-group">
                <div class="col-md-2 control-label"><b>当前头像</b></div>
                  <div class="controls col-md-8 controls">
          	         <?php if(empty($avatar)): ?><img src="./themes/simplebootx/public/images/093958e59110293063.jpg" class="headicon"/>
			         <?php else: ?>
				        <img src="<?php echo sp_get_user_avatar_url($avatar);?>?t=<?php echo time();?>" class="headicon"/><?php endif; ?>
			         <input type="file" onchange="avatar_upload(this)" id="avatar_uploder"  name="file" class="form-control" style="margin-top:10px;margin-bottom:10px;width:250px;"/>
...
<script type="text/javascript">
	...
	function avatar_upload(obj){
		...
		Wind.use("ajaxfileupload","jcrop","noty",function(){
			$.ajaxFileUpload({
				url:"<?php echo u('user/center/avatar_upload');?>",
				secureuri:false,
