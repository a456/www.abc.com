...
<body>
				...
				<div class="server">
					<table width="100%">
						...
						<tr>
							...
							<td><input type="text" name="dbname" id="dbname" value="YxtCMF" class="input"></td>
							<td><div id="js-install-tip-dbname"></div></td>
						</tr>
						<tr>
							<td class="text-left">数据库表前缀：</td>
							<td><input type="text" name="dbprefix" id="dbprefix" value="yxt_" readOnly="true" class="input"></td>
							<td>
								<div id="js-install-tip-dbprefix">
									<span class="gray">建议使用默认，同一数据库安装多个YxtCMF时需修改</span>
								</div>
							</td>
						</tr>
					</table>
					<table width="100%">
						...
						<tr>
							...
							<td><input type="text" name="sitename" value="YxtCMF网络课堂" class="input"></td>
						...
						<tr>
							...
							<td><input type="text" name="sitekeywords" value="YxtCMF,网络课堂，微课，翻转课堂" class="input" autoComplete="off"></td>
							<td><div id="js-install-tip-sitekeywords"></div></td>
						</tr>
						<tr>
							<td class="text-left">描述：</td>
							<td><input type="text" name="siteinfo" class="input" value="YxtCMF是易学堂发布的一款用于快速建立网校的内容管理框架"></td>
		...
		<script>
			...
			$(function() {
				...
				var focus_tips = {
					...
					dbpw : '',
					dbname : '',
					dbprefix : '建议使用默认，同一数据库安装多个YxtCMF时需修改',
	...
	<div class="footer">
	&copy; 2013-<?php echo date('Y');?> <a href="http://www.thinkcmf.com" target="_blank">TxTCMF</a>易学堂出品
</div>
</body>
</html>