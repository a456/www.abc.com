...
<body>
	<div class="wrap js-check-wrap">
		<ul class="nav nav-tabs">
			...
			<li><a href="#E" data-toggle="tab">腾讯云存储配置</a></li>
		</ul>
					...
					<div class="tab-content">
						...
						<div class="tab-pane" id="D">
							<div class="control-group">
									...
									<div class="controls">
										<input type="text" style="width:500px" name="options[seller_email]" value="<?php echo ($alipayconfig['seller_email']); ?>">
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">支付宝key</label>
									<div class="controls">
										<input type="text" style="width:500px" name="options[key]" value="<?php echo ($alipayconfig['key']); ?>">
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">支付宝partner</label>
									<div class="controls">
										<input type="text" style="width:500px" name="options[partner]" value="<?php echo ($alipayconfig['partner']); ?>">
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">notify_url</label>
									<div class="controls">
										<input type="text" style="width:500px" name="options[notify_url]" value="<?php echo ($alipayconfig['notify_url']); ?>">只需修改域名即可
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">return_url</label>
									<div class="controls">
										<input type="text" style="width:500px" name="options[return_url]" value="<?php echo ($alipayconfig['return_url']); ?>">只需修改域名即可
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">successpage</label>
									<div class="controls">
										<input type="text" style="width:500px" name="options[successpage]" value="<?php echo ($alipayconfig['successpage']); ?>">只需修改域名即可
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">errorpage</label>
									<div class="controls">
										<input type="text" style="width:500px" name="options[errorpage]" value="<?php echo ($alipayconfig['errorpage']); ?>">只需修改域名即可
									</div>
								</div>
						</div>
						<div class="tab-pane" id="E">
							   <div class="control-group">
									...
									<div class="controls">
										<input type="text" style="width:300px" name="options[APPID]" value="<?php echo ($tencent['APPID']); ?>">
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">SECRET_ID</label>
									<div class="controls">
										<input type="text" style="width:300px" name="options[SECRET_ID]" value="<?php echo ($tencent['SECRET_ID']); ?>">
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">SECRET_KEY</label>
									<div class="controls">
										<input type="text" style="width:300px" name="options[SECRET_KEY]" value="<?php echo ($tencent['SECRET_KEY']); ?>">
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">域名空间</label>
									<div class="controls">
										<input type="text" style="width:300px" name="options[DOMAIN]" value="<?php echo ($tencent['DOMAIN']); ?>">
									</div>
								</div>
						</div>
