...
class taskClassAction extends Action
{
	...
	public function downbatAjax()
	{
		...
		echo '<font color="red">如您有安装服务端，就不用根据下面来开启计划任务了</font><br><a target="_blank" style="color:blue" href="'.URLY.'view_taskrun.html">查看官网上帮助</a><br>';
...
'.getconfig('phppath','php').' '.$ljth.'\task.php runt,task';
		...
		echo '<div style="background:#caeccb;padding:5px;border:1px #888888 solid;border-radius:5px;">';
		echo 'schtasks /create /sc DAILY /mo 1 /du "24:00" /ri 5 /sd "2017/04/01" /st "00:00:05"  /tn "OA计划任务" /ru System /tr '.$ljth.'\\'.UPDIR.'\xinhutaskrun.bat';
		echo '</div>';
